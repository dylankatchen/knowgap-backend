#!/usr/bin/env python3
"""
Create Demo Instructor Account via API
=====================================

This script creates the demo instructor account by calling the backend API directly.
This is the most reliable method as it uses the production backend.

Usage:
    python3 create_demo_via_api.py
"""
...
async def main():
    """Main function."""
    print("🎯 AchieveUp Demo Account Creator (API Version)")
    print("=" * 55)
    print()
